...
class CPump(Actuator):
    ...
    def update(self, input) -> float():
        ...
        Returns: 
            Scaled output value between output min and max values
        
        '''
        self._output = self._output_max - self._output_min
        self._output /= self._input_max - self._input_min
        self._output *= input - self._input_min
